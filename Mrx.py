...
princp = []
try:
    prox = requests.get('https://github.com/MATAL-BREND/MATAL/blob/main/MATAL.txt').text
...
def uaku():
    try:
        ...
        a = requests.get('https://github.com/MATAL-BREND/MATAL/blob/main/MATAL.txt').text
        ua = open('bbnew.txt', 'w')
